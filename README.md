...
| `prepare-pr` | Bump the version and regenerate `CHANGELOG.md`, leaving both staged for the caller to commit. Prints the next version as JSON (`version`); the caller opens the publish PR. |
